...
local function apply_theme_overrides()
  ...
  set(0, "@variable.builtin", { fg = colors.variable, italic = true })
  set(0, "@variable.member", { fg = colors.variable })
  ...
  set(0, "@repeat", { fg = colors.blue })
  set(0, "@operator", { fg = colors.purple })
  set(0, "@punctuation", { fg = colors.muted })
  set(0, "@punctuation.bracket", { fg = colors.muted })
  set(0, "@punctuation.delimiter", { fg = colors.muted })
  set(0, "@punctuation.special", { fg = colors.muted })
  set(0, "@module", { fg = colors.fg })
  set(0, "@namespace", { fg = colors.fg })
  set(0, "@type", { fg = colors.cyan })
  set(0, "@type.builtin", { fg = colors.cyan })
  set(0, "@constant", { fg = colors.light_green })
  set(0, "@constant.go", { fg = colors.blue })
  set(0, "@constant.builtin", { fg = colors.blue })
  set(0, "@lsp.typemod.variable.readonly.go", { fg = colors.blue })
  set(0, "@lsp.typemod.property.readonly.go", { fg = colors.blue })
