...
setg pane-active-border-style "fg=$green,bg=$bg"
...
setw window-status-style "fg=$muted,bg=$bg"
setw window-status-current-style "fg=$fg,bg=$bg_alt"
setw window-status-activity-style "fg=$yellow,bg=$bg"

setg status-left "#[fg=$bg,bg=$green,bold] #S #[fg=$green,bg=$bg,nobold] "
setw window-status-format "#[fg=$muted,bg=$bg] #I:#W "
setw window-status-current-format "#[fg=$fg,bg=$bg_alt,bold] #I:#W "
