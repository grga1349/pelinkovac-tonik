...
setg status-style "fg=$fg,bg=$bar_bg"
...
setg display-panes-colour "$fg"

setw window-status-separator "#[fg=$fg,bg=$bar_bg] "
setw window-style "fg=$fg,bg=$bg"
setw window-active-style "fg=$fg,bg=$bg"
setw window-status-style "fg=$fg,bg=$bar_bg"
setw window-status-current-style "fg=$accent,bg=$bar_bg,bold"
setw window-status-activity-style "fg=$yellow,bg=$bar_bg"

setg status-left "#[fg=$fg,bg=$bar_bg,bold] #S #[fg=$fg,bg=$bar_bg,nobold] "
setw window-status-format "#[fg=$fg,bg=$bar_bg] #I:#W "
setw window-status-current-format "#[fg=$accent,bg=$bar_bg,bold] #I:#W "

if [ -n "$widgets" ]; then
  setg status-right "#[fg=$fg,bg=$bar_bg] ${widgets} ${time_format} ${date_format} "
else
  setg status-right "#[fg=$fg,bg=$bar_bg] ${time_format} ${date_format} "
fi
